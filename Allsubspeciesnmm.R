...
morpho.data <- read.csv("~/Downloads/Unicolor_r.csv")
...
#
postscript("allgroupselection.eps", horizontal = FALSE, onefile= FALSE, paper = "special", width = 10, height = 10)
...
postscript("allspeciesscattergroups.eps", width = 480, height = 480)
#PC1/2
...
plot(Mcluster.morpho.data.ln.pca.subset$data[,trait.x], Mcluster.morpho.data.ln.pca.subset$data[,trait.y],
     ...
     cex.axis=1.5, cex.lab=1.5, bty="n",col=col.BestModel, pch=21, xlim=c(-5,5.5), ylim=c(-3,3),
     cex=1.5, lwd=2)
...
plot(c(0,1), c(0,1), type="n", axes=F, bty="n", 
     xlab="", ylab="")
legend(0.1, 1,
       paste("Morphological group", 1:4),
       col=morpho.groups.colors[1:4], 	pch=21, pt.lwd=2, pt.cex=1.5, cex=1.45, bty="o")
...
plot(Mcluster.morpho.data.ln.pca.subset$data[,trait.x], Mcluster.morpho.data.ln.pca.subset$data[,trait.y],
     xlab=colnames(Mcluster.morpho.data.ln.pca.subset$data)[trait.x], ylab=colnames(Mcluster.morpho.data.ln.pca.subset$data)[trait.y],
     cex.axis=1.5, cex.lab=1.5, bty="n",col=morpho.data$Taxon, pch=21, xlim=c(-5,5.5), ylim=c(-3,3),
     cex=1.5, lwd=2)
#plot legend
par(mar=c(0, 0, 0, 0))
plot(c(0,1), c(0,1), type="n", axes=F, bty="n", 
     xlab="", ylab="")
legend(0.1, 1,
       c(expression(italic("concolor")), expression(italic("oaxacae")), expression(italic("guerrensis")), expression(italic("unicolor")), expression(italic("griscomi"))),
...
col.BestModel[Mcluster.morpho.data.ln.pca.subset.G3$classification==4] <- morpho.groups.colors[4]
col.BestModel[Mcluster.morpho.data.ln.pca.subset.G3$classification==5] <- morpho.groups.colors[5]
...
#define morphogroup colors
postscript("allbargraph.eps", horizontal = FALSE, onefile= FALSE, paper = "special", width = 10, height = 10)
...
hist(Mcluster.morpho.data.ln.pca.subset$classification[morpho.data$Taxon=="concolor"], 
...
axis(1, at=1:Mcluster.morpho.data.ln.pca.subset$G, labels=T)

hist(Mcluster.morpho.data.ln.pca.subset$classification[morpho.data$Taxon=="guerrerensis"], 
     breaks=seq(0.75, Mcluster.morpho.data.ln.pca.subset$G+0.25, 0.5),
     main=expression(italic("guerrerensis")), xlab="", ylab="",
     cex.lab=1.5, cex.axis=1.5, col=morpho.groups.colors.hist, xaxt="n") 
axis(1, at=1:Mcluster.morpho.data.ln.pca.subset$G, labels=T)

hist(Mcluster.morpho.data.ln.pca.subset$classification[morpho.data$Taxon=="oaxacae"], 
     breaks=seq(0.75, Mcluster.morpho.data.ln.pca.subset$G+0.25, 0.5),
     main=expression(italic("oaxacae")), xlab="", ylab="",
     cex.lab=1.5, cex.axis=1.5, col=morpho.groups.colors.hist, xaxt="n") 
axis(1, at=1:Mcluster.morpho.data.ln.pca.subset$G, labels=T)

hist(Mcluster.morpho.data.ln.pca.subset$classification[morpho.data$Taxon=="unicolor"], 
     breaks=seq(0.75, Mcluster.morpho.data.ln.pca.subset$G+0.25, 0.5),
     main=expression(italic("unicolor")), xlab="", ylab="",
     cex.lab=1.5, cex.axis=1.5, col=morpho.groups.colors.hist, xaxt="n") 
axis(1, at=1:Mcluster.morpho.data.ln.pca.subset$G, labels=T)

hist(Mcluster.morpho.data.ln.pca.subset$classification[morpho.data$Taxon=="griscomi"], 
     breaks=seq(0.75, Mcluster.morpho.data.ln.pca.subset$G+0.25, 0.5),
